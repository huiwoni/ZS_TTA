...
for nshot in 0
do
  CUDA_LAUNCH_BLOCKING=1 python ./dmn_main.py ${data_root} --test_sets ${testsets} --selection_p ${selection_p}  \
  -a ${arch} -b ${bs}  --ctx_init ${ctx_init}  --memory_size 50 --text_prompt tip  --log camera_ready_dmn_tf_searched_32_01_vit \
